...
const testUserPlayersAPI = async () => {
  try {
    ...
    apiTestResult.value = { api: "user_player", error: error.message }
  }
}
...
const testTeamsAPI = async () => {
  try {
    ...
    apiTestResult.value = { api: "team", error: error.message }
  }
}
...
const testTeamStaffAPI = async () => {
  try {
    ...
    apiTestResult.value = { api: "team_staff", error: error.message }
  }
}
